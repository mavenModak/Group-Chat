...
export class ChatService {
  ...
  // retrieves the chat where user is in.
  getUserChats() {
  ...
  // It grabs the unique IDs from the chat messages array,
  // then joins the user profile data to each message and keeps the entire payload synced in realtime.
